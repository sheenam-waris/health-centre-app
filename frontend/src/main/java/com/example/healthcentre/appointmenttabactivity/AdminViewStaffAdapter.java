...
public class AdminViewStaffAdapter extends RecyclerView.Adapter<AdminStaffViewHolder> {
    private ArrayList<User> userData;

    public AdminViewStaffAdapter(ArrayList<User> userData) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, StaticDataProvider.getApiBaseUrl()+"/user/remove-by-id", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    switch(status) {
                        case "SUCCESS":
                            String msg = "Successfully Deleted Staff : " + user_id;
...
class AdminStaffViewHolder extends RecyclerView.ViewHolder{
